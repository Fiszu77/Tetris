...
class Button
{
  ...
  public boolean show(Button[] other)
  {
    ...
    textSize(txtSize-15);
    text(onButt, posx, posy+0.6f*var);
...
class Play
{
  ...
  Play()
  {
    ...
    agdv = false;
    pause = false;
    resumePress = new Button(PApplet.parseFloat(width)/2, 15*var, blue, "Resume", 10*varInt);
    restartPress =  new Button(PApplet.parseFloat(width)/2, 19*var, yellow, "Menu", 10*varInt);
...
class Timer
{
  ...
  public void settings() {  size(540, 720); }
